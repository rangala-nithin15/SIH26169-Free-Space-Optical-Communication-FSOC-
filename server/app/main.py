...
async def video_analyze(
    ...
    try:
        ...
        params = VideoParams(hfov_deg=hfovDeg, spot_size_px=spotSizePx, threshold_sigma=thresholdSigma)
    ...
    return {"id": vid, "summary": json_safe(res["summary"]), "csv": f"/api/video/{vid}/csv"}

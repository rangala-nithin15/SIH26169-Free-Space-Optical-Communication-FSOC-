  ...
  return (
    <div>
      <svg
        width={W}
        height={H}
        style={{ background: 'rgba(14,22,34,0.6)', borderRadius: 6, cursor: 'crosshair', border: '1px solid var(--line)' }}
        onClick={(e) => {
      ...
      >
        <line x1={X(-hu)} y1={Y(0)} x2={X(hu)} y2={Y(0)} stroke="rgba(170,214,255,0.12)" />
        <line x1={X(0)} y1={Y(-hv)} x2={X(0)} y2={Y(hv)} stroke="rgba(170,214,255,0.12)" />
...
function PinholeDiagram({ cfg }: { cfg: SimConfig }) {
  ...
  return (
    <svg width="290" height="120" viewBox="0 0 290 120" style={{ display: 'block', margin: '4px 0 8px' }}>
      ...
      <line x1="30" y1="20" x2="280" y2="98" stroke="rgba(143,220,255,0.45)" />
      <line x1="30" y1="100" x2="280" y2="22" stroke="rgba(143,220,255,0.45)" />
      <line x1="30" y1="60" x2="280" y2="60" stroke="rgba(232,240,247,0.3)" strokeDasharray="3 3" />
    ...
    <>
      <Section title="Render quality">
        <Seg
          ...
          onChange={setQuality}
        />
        <p className="note">Low: no post-processing, no clouds, 2k land mask. Medium: bloom, clouds. High: 4× MSAA, shadows, 2× pixel ratio, 30 Hz sensor feed.</p>
      </Section>
